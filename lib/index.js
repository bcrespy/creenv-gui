...
class GUI extends HUDElement {
   ...
   * @param {?boolean} visible weither the GUI is closed or not
   * @param {?boolean} appendToDom weither the GUI will be added to the dom or not 
   * @param {?HTMLElement} parent the container of the GUI
   */
  constructor (controls, position = GUI.POSITION.TOP_RIGHT, visible = true, appendToDom = true, parent = document.body) {
    super(visible);
